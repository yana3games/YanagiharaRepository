...
///////////////////////////////////////////////////////////////////////////////
// コンストラクタ
TerrainDefaultShader::TerrainDefaultShader(void)
{
  CreateMatrixBuffer();
  CreateShader();
}
...
///////////////////////////////////////////////////////////////////////////////
// パラメータのセット
void TerrainDefaultShader::SetParameters(DirectX::XMMATRIX& World, const DirectX::XMMATRIX& View, const DirectX::XMMATRIX& Proj, Texture* texture)
{
  // シェーダを設定して描画
...
///////////////////////////////////////////////////////////////////////////////
// 行列コンスタントバッファの作成
void TerrainDefaultShader::CreateMatrixBuffer(void)
{
  // マトリクスバッファの設定.
...
///////////////////////////////////////////////////////////////////////////////
// シェーダの作成
void TerrainDefaultShader::CreateShader(void)
{
  ...
  shaderManager->LoadVS("./data/SHADER/VertexShader/terrainVS.cso", layout, numElements);
  ShaderManager::VertexShader VS = shaderManager->GetVS("./data/SHADER/VertexShader/terrainVS.cso");
  m_pVS = VS.pVS;
  m_pIL = VS.pIL;

  shaderManager->LoadPS("./data/SHADER/PixelShader/terrainPS.cso");
  m_pPS = AppManager::GetShaderManager()->GetPS("./data/SHADER/PixelShader/terrainPS.cso");
}
