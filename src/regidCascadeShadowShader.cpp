...
///////////////////////////////////////////////////////////////////////////////
// コンストラクタ
RegidCascadeShadowShader::RegidCascadeShadowShader(void)
{
  CreateMatrixBuffer();
  CreateSunBuffer();
  CreateShader();
...
///////////////////////////////////////////////////////////////////////////////
// パラメータのセット
void RegidCascadeShadowShader::SetParameters(DirectX::XMMATRIX& World, const DirectX::XMMATRIX& View, const DirectX::XMMATRIX& Proj, const DirectX::XMMATRIX& WIT, Texture* texture)
{
  // シェーダを設定して描画
...
///////////////////////////////////////////////////////////////////////////////
// 行列コンスタントバッファの作成
void RegidCascadeShadowShader::CreateMatrixBuffer(void)
{
  // マトリクスバッファの設定.
...
///////////////////////////////////////////////////////////////////////////////
// 太陽コンスタントバッファの作成
void RegidCascadeShadowShader::CreateSunBuffer(void)
{
  // マトリクスバッファの設定.
  D3D11_BUFFER_DESC bd;
  ZeroMemory(&bd, sizeof(D3D11_BUFFER_DESC));
...
///////////////////////////////////////////////////////////////////////////////
// シェーダの作成
void RegidCascadeShadowShader::CreateShader(void)
{
  ...
  shaderManager->LoadVS("./data/SHADER/VertexShader/regidCascadeShadowVS.cso", layout, numElements);
  ShaderManager::VertexShader VS = shaderManager->GetVS("./data/SHADER/VertexShader/regidCascadeShadowVS.cso");
  m_pVS = VS.pVS;
  m_pIL = VS.pIL;
  shaderManager->LoadPS("./data/SHADER/PixelShader/regidCascadeShadowPS.cso");
  m_pPS = shaderManager->GetPS("./data/SHADER/PixelShader/regidCascadeShadowPS.cso");
}
